...
if($_POST){
    ...
    if(empty($id_transaksi)){
        ...
        if($insert){
            echo "<script>alert('Sukses menambahkan data transaksi');location.href='tambah_detail_transaksi.php';</script>";
        } else {
            echo "<script>alert('Gagal menambahkan data transaksi');location.href='tambah_detail_transaksi.php';</script>";
        }
    }
}
?>